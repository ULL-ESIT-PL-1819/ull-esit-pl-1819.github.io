...
%  {\bf DESARROLLO DE SISTEMAS INFORMÁTICOS: 3ª PARTE}\\
   {\bf DESARROLLO DE SISTEMAS INFORMÁTICOS: CONVOCATORIA DE SEPTIEMBRE}\\
   07/09/2017  \pageref*{LastPage} páginas         \\   
  \end{tabular}                     % &
%  \begin{tabular}{c}
%   {\bf Universidad de La Laguna.  Escuela Técnica Superior de Ingeniería Informática}     \\
%   {\bf Tercero del Grado de Informática}\\
...
%\input{pruebasdsi2} % Mocha / Should
